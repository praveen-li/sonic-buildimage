...
class PlatformGlobalData():
    ...
    KEY_BLUE_FANS_INLET_TEMP_LOW_THRESHOLD = 'blue_fans_inlet_temp_low_threshold'
    KEY_RED_FANS_INLET_TEMP_LOW_THRESHOLD = 'red_fans_inlet_temp_low_threshold'
    KEY_BLUE_FANS_INLET_TEMP_HIGH_THRESHOLD = 'blue_fans_inlet_temp_high_threshold'
    KEY_RED_FANS_INLET_TEMP_HIGH_THRESHOLD = 'red_fans_inlet_temp_high_threshold'
