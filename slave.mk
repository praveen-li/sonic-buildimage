...
$(addprefix $(TARGET_PATH)/, $(SONIC_INSTALLERS)) : $(TARGET_PATH)/% : \
	...
	export sonic_netops_util_py2_wheel_path="$(addprefix $(PYTHON_WHEELS_PATH)/,$(SONIC_NETOPS_UTIL_PY2))"
