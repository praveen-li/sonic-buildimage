...
def parse_xml(filename, platform=None, port_config_file=None, asic_name=None, hwsku_config_file=None):
    ...
    (ports, alias_map, alias_asic_map) =  \
        get_port_config(hwsku=hwsku, platform=platform, port_config_file=port_config_file, \
                        asic=asic_id, hwsku_config_file=hwsku_config_file)
