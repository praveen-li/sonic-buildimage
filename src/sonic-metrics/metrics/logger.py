...
class Logger(object):
    """
    Logger class for metricsd Daemon.
    """
    ...
    def __init__(self, log_identifier=None, log_facility=DEFAULT_LOG_FACILITY, log_option=DEFAULT_LOG_OPTION):
        ...
        self.set_priority(self.LOG_PRIORITY_NOTICE)
